...
const profiles = [
  { id: 'user-wyz', name: '吴媛智', email: 'wyz@example.local', role: Role.SECRETARY, phone: null, studentId: null, departmentId: 'dept-org', joinedAt: new Date('2025-09-01T00:00:00Z') },
